...
public class BoardQAEmpController {
    ...
    void viewBoard(MouseEvent event) {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/Board/fxml/ViewQAEmp.fxml"));
		Parent root ;
		try {
		root = loader.load();
		anchoPane.getChildren().setAll(root);
		ViewQAEmpController controller = loader.getController();
...
//		stage.setScene(scene);
    ...
    @FXML
    void initialize() {
    	assert table != null : "fx:id=\"table\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert col_no != null : "fx:id=\"col_no\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert col_title != null : "fx:id=\"col_title\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert col_writer != null : "fx:id=\"col_writer\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert col_secret != null : "fx:id=\"col_secret\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert col_date != null : "fx:id=\"col_date\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert pagination != null : "fx:id=\"pagination\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert combo != null : "fx:id=\"combo\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert tf != null : "fx:id=\"tf\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
        assert btn_search != null : "fx:id=\"btn_search\" was not injected: check your FXML file 'BoardQAEmp.fxml'.";
