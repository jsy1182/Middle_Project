...
public class BoardEmpMainController {
    ...
    void viewBoard(MouseEvent event) {
    	...
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("/Board/fxml/ViewBoardEmp.fxml"));
 
		Parent child;
		try {
			child = loader.load();
			anchoPane.getChildren().setAll(child);
			ViewBoardEmpController viewBoardController = loader.getController();
...
//			stage.setScene(scene);
    ...
    @FXML
    void initialize() {
        assert label != null : "fx:id=\"label\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert notice != null : "fx:id=\"notice\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert col_no != null : "fx:id=\"col_no\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert col_title != null : "fx:id=\"col_title\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert col_writer != null : "fx:id=\"col_writer\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert col_date != null : "fx:id=\"col_date\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert pagination != null : "fx:id=\"pagination\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert combo != null : "fx:id=\"combo\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert tf != null : "fx:id=\"tf\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
        assert btn_search != null : "fx:id=\"btn_search\" was not injected: check your FXML file 'BoardEmpMain.fxml'.";
