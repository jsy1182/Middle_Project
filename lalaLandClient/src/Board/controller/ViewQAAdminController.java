...
public class ViewQAAdminController {
	AdminVO admin ; 
	BoardVO board;
...
//			stage.setScene(scene);
    ...
    void click_update(ActionEvent event) {
		...
		String mem_id=admin.getAdmin_id();
    ...
    @FXML
    void initialize() {
        assert tf_title != null : "fx:id=\"tf_title\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert la_date != null : "fx:id=\"la_date\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert ta != null : "fx:id=\"ta\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert radio != null : "fx:id=\"radio\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert answer != null : "fx:id=\"answer\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert la_answer != null : "fx:id=\"la_answer\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert btn_ != null : "fx:id=\"btn_\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert btn_delete != null : "fx:id=\"btn_delete\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert btn_goback != null : "fx:id=\"btn_goback\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert la_writer != null : "fx:id=\"la_writer\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert tf_secret != null : "fx:id=\"tf_secret\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert la_reply2 != null : "fx:id=\"la_reply2\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
        assert la_reply != null : "fx:id=\"la_reply\" was not injected: check your FXML file 'ViewQAAdmin.fxml'.";
