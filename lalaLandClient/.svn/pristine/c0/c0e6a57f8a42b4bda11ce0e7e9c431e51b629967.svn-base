...
public class ViewBoardEmpController {
...
//			stage.setScene(scene);
    ...
    @FXML
    void initialize() {
        assert tf_title != null : "fx:id=\"tf_title\" was not injected: check your FXML file 'ViewBoardEmp.fxml'.";
        assert la_date != null : "fx:id=\"la_date\" was not injected: check your FXML file 'ViewBoardEmp.fxml'.";
        assert ta != null : "fx:id=\"ta\" was not injected: check your FXML file 'ViewBoardEmp.fxml'.";
        assert btn_goback != null : "fx:id=\"btn_goback\" was not injected: check your FXML file 'ViewBoardEmp.fxml'.";
